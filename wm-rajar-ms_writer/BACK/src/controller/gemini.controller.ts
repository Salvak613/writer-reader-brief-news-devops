...
class GeminiController {
    ...
    async generateTitle(req: Request, res: Response): Promise<void> {
        try {
            ...
            if (!geminiService) {
                res.status(503).json({ error: "Service Gemini non disponible (GEMINI_API_KEY manquante)" });
                return;
            }
    ...
    async generateSubtitle(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur lors de la génération du sous-titre :", error);
    ...
    async generateSubhead(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur lors de la génération du chapeau:", error);
    ...
    async generateBody(req: Request, res: Response): Promise<void> {
        try {
            ...
            console.error("Erreur lors de la génération du body:", error);
